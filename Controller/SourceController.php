...
use Lb\RssrBundle\Form\SourceType;
...
class SourceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LbRssrBundle:Source')->findAll();

        return $this->render('LbRssrBundle:Source:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LbRssrBundle:Source')->find($id);
        ...
        return $this->render('LbRssrBundle:Source:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('LbRssrBundle:Source:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('LbRssrBundle:Source:edit.html.twig', array(
            'entity'      => $entity,
